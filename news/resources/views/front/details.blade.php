            ...
            <div class="col-md-8">
                ...
                <div class="readers_comment">
                    ...
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img alt="64x64" class="media-object" data-src="{{ asset('public/front/img/reader_img1.jpg') }}"
                                src="{{ asset('public/front/img/reader_img1.jpg') }}" data-holder-rendered="true">
                            </a>
                        </div>
                        <div class="media-body">
                            ...
                            <div class="media">
                                <div class="media-left">
                                    <a href="#">
                                        <img alt="64x64" class="media-object" data-src="{{ asset('public/front/img/reader_img2.jpg') }}"
                                        src="{{ asset('public/front/img/reader_img2.jpg') }}" data-holder-rendered="true">
                                    </a>
                                </div>
                                <div class="media-body">
                    ...
                    <div class="media">
                        <div class="media-left">
                            <a href="#">
                                <img alt="64x64" class="media-object" data-src="{{ asset('public/front/img/reader_img3.jpg') }}"
                                src="{{ asset('public/front/img/reader_img3.jpg') }}" data-holder-rendered="true">
                            </a>
                        </div>
                        <div class="media-body">
